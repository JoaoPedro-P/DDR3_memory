...
module inicialization_control_logic #(parameter freq = 100) (
    ...
    localparam init_stab   = 200 * freq; // PT: Espera 200us | EN: 200us Wait
    localparam reset_CKE_n = 500 * freq; // PT: Espera 500us | EN: 500us Wait
    ...
    // -------------------------------------------------------------------------
    // PT: Bloco 1: Lógica de Saída (Combinacional) | EN: Block 1: Output Logic
    // -------------------------------------------------------------------------
    always @ (state) begin
        ...
        case (state)
            ...
            ISSUE_MR2: begin
                CS_n = 1'b0; RAS_n = 1'b0; CAS_n = 1'b0; WE_n = 1'b0; // MRS
                BA = 3'd2;
            end
            ...
            ISSUE_ZQCL: begin
                CS_n = 1'b0; RAS_n = 1'b1; CAS_n = 1'b1; WE_n = 1'b0; // ZQCL
