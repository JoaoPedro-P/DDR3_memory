...
module row_tracker(
    ...
    // PT: Array para armazenar o endereço da linha aberta em cada banco
    // EN: Array to store the open row address for each bank
    ...
    // PT: Atualização do registro de linhas | EN: Update row registers
